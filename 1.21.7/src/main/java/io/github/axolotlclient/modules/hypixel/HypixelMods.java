...
public class HypixelMods extends AbstractModule {
	...
	public final EnumOption<HypixelCacheMode> cacheMode =
		new EnumOption<>("cache_mode", HypixelCacheMode.class, HypixelCacheMode.ON_CLIENT_DISCONNECT);
	...
	public void init() {
		...
		ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(HypixelMessages.getInstance());
