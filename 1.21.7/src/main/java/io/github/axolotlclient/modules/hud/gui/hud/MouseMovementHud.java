...
public class MouseMovementHud extends BoxHudEntry {
	...
	public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("kronhud", "mousemovementhud");
	...
	public void renderComponent(GuiGraphics graphics, float delta) {
		...
		graphics.blit(RenderPipelines.GUI_TEXTURED, io.github.axolotlclient.util.Util.getTexture(mouseMovementIndicatorInner),
			spaceX + (width / 2) - 7 / 2 - 1, spaceY + 17 - (7 / 2), 0, 0, 7, 7, 7, 7);

		graphics.pose().translate(calculatedMouseX, calculatedMouseY); // Woah KodeToad, good use of translate

		graphics.blit(RenderPipelines.GUI_TEXTURED, io.github.axolotlclient.util.Util.getTexture(mouseMovementIndicatorOuter),
